...
- Tauri + Vite + React + TypeScript desktop scaffold for Windows, with aligned Tauri 2.9.1 Rust/npm versions, npm peer overrides, and Rust 1.88.0 toolchain metadata.
