...
- Tauri + Vite + React + TypeScript desktop scaffold for Windows, with aligned Tauri 2.9.1 Rust/npm versions, npm peer overrides, patched Vite 6.4.2, React Router 6.30.3, ESLint 9.39.4, and Rust 1.88.0 toolchain metadata.
